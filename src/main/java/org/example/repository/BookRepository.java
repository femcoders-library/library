...
public class BookRepository {
    // This class will handle database operations related to books
    // For example, methods to add, update, delete, and retrieve books from the database

    // Example method to add a book
    public void addBook(String title, String synopsis, String isbn, String author, String genre) {
    ...
    public List<Book> findAllBooks() {
        ...
        try {
            ...
            while (response.next()) {
                ...
                Book book = new Book(id, title, synopsis, isbn, author, genre);
                books.add(book);
